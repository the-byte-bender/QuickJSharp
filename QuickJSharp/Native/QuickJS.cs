...
public static unsafe partial class QuickJS
{
    ...
    public struct JSValueUnion
    {
        ...
        [FieldOffset(0)] public int short_big_int;
    }
    ...
    public static bool JS_VALUE_IS_BOTH_INT(JSValue v1, JSValue v2) => ((JS_VALUE_GET_TAG(v1) | JS_VALUE_GET_TAG(v2)) == 0);
    public static bool JS_VALUE_IS_BOTH_FLOAT(JSValue v1, JSValue v2) => JS_TAG_IS_FLOAT64(JS_VALUE_GET_TAG(v1)) && JS_TAG_IS_FLOAT64(JS_VALUE_GET_TAG(v2));
    ...
    [LibraryImport("quickjs")]
    public static partial int JS_AddRuntimeFinalizer(JSRuntime* rt, delegate* unmanaged[Cdecl]<JSRuntime*, void*, void> finalizer, void* arg);

    [LibraryImport("quickjs")]
    public static partial void JS_MarkValue(JSRuntime* rt, JSValue val, delegate* unmanaged[Cdecl]<JSRuntime*, JSGCObjectHeader*, void> mark_func);
    ...
    public struct JSClassExoticMethods
    {
        ...
        public delegate* unmanaged[Cdecl]<JSContext*, JSValue, JSAtom, JSValue, JSValue, JSValue, int, int> define_own_property;
    ...
    [LibraryImport("quickjs")] public static partial JSValue JS_NewInternalError(JSContext* ctx, byte* fmt);
    [LibraryImport("quickjs")] public static partial JSValue JS_NewPlainError(JSContext* ctx, byte* fmt);
    [LibraryImport("quickjs")] public static partial JSValue JS_NewRangeError(JSContext* ctx, byte* fmt);
    [LibraryImport("quickjs")] public static partial JSValue JS_NewReferenceError(JSContext* ctx, byte* fmt);
    [LibraryImport("quickjs")] public static partial JSValue JS_NewSyntaxError(JSContext* ctx, byte* fmt);
    [LibraryImport("quickjs")] public static partial JSValue JS_NewTypeError(JSContext* ctx, byte* fmt);

    [LibraryImport("quickjs")] public static partial JSValue JS_ThrowInternalError(JSContext* ctx, byte* fmt);
    [LibraryImport("quickjs")] public static partial JSValue JS_ThrowPlainError(JSContext* ctx, byte* fmt);
    [LibraryImport("quickjs")] public static partial JSValue JS_ThrowRangeError(JSContext* ctx, byte* fmt);
    [LibraryImport("quickjs")] public static partial JSValue JS_ThrowReferenceError(JSContext* ctx, byte* fmt);
    [LibraryImport("quickjs")] public static partial JSValue JS_ThrowSyntaxError(JSContext* ctx, byte* fmt);
    [LibraryImport("quickjs")] public static partial JSValue JS_ThrowTypeError(JSContext* ctx, byte* fmt);
    [LibraryImport("quickjs")] public static partial JSValue JS_ThrowDOMException(JSContext* ctx, byte* name, byte* fmt);
    ...
    [LibraryImport("quickjs")]
    public static partial byte* JS_ToCStringLen2(JSContext* ctx, nuint* plen, JSValue val1, [MarshalAs(UnmanagedType.I1)] bool cesu8);

    public static byte* JS_ToCStringLen(JSContext* ctx, nuint* plen, JSValue val1) => JS_ToCStringLen2(ctx, plen, val1, false);
    ...
    [LibraryImport("quickjs")] public static partial void JS_FreeCString(JSContext* ctx, byte* ptr);
    [LibraryImport("quickjs")] public static partial void JS_FreeCStringRT(JSRuntime* rt, byte* ptr);
    [LibraryImport("quickjs")] public static partial void JS_FreeCStringUTF16(JSContext* ctx, ushort* ptr);
    [LibraryImport("quickjs")] public static partial void JS_FreeCStringRT_UTF16(JSRuntime* rt, ushort* ptr);

    [LibraryImport("quickjs")] public static partial JSValue JS_NewObjectProtoClass(JSContext* ctx, JSValue proto, JSClassID class_id);
    [LibraryImport("quickjs")] public static partial JSValue JS_NewObjectClass(JSContext* ctx, JSClassID class_id);
    [LibraryImport("quickjs")] public static partial JSValue JS_NewObjectProto(JSContext* ctx, JSValue proto);
    [LibraryImport("quickjs")] public static partial JSValue JS_NewObject(JSContext* ctx);
    [LibraryImport("quickjs")] public static partial JSValue JS_NewObjectFrom(JSContext* ctx, int count, JSAtom* props, JSValue* values);
    [LibraryImport("quickjs")] public static partial JSValue JS_NewObjectFromStr(JSContext* ctx, int count, byte** props, JSValue* values);
    [LibraryImport("quickjs")] public static partial JSValue JS_ToObject(JSContext* ctx, JSValue val);
    [LibraryImport("quickjs")] public static partial JSValue JS_ToObjectString(JSContext* ctx, JSValue val);

    [LibraryImport("quickjs")][return: MarshalAs(UnmanagedType.I1)] public static partial bool JS_IsFunction(JSContext* ctx, JSValue val);
    [LibraryImport("quickjs")][return: MarshalAs(UnmanagedType.I1)] public static partial bool JS_IsConstructor(JSContext* ctx, JSValue val);
    [LibraryImport("quickjs")][return: MarshalAs(UnmanagedType.I1)] public static partial bool JS_SetConstructorBit(JSContext* ctx, JSValue func_obj, [MarshalAs(UnmanagedType.I1)] bool val);

    [LibraryImport("quickjs")][return: MarshalAs(UnmanagedType.I1)] public static partial bool JS_IsRegExp(JSValue val);
    [LibraryImport("quickjs")][return: MarshalAs(UnmanagedType.I1)] public static partial bool JS_IsMap(JSValue val);
    [LibraryImport("quickjs")][return: MarshalAs(UnmanagedType.I1)] public static partial bool JS_IsSet(JSValue val);
    [LibraryImport("quickjs")][return: MarshalAs(UnmanagedType.I1)] public static partial bool JS_IsWeakRef(JSValue val);
    [LibraryImport("quickjs")][return: MarshalAs(UnmanagedType.I1)] public static partial bool JS_IsWeakSet(JSValue val);
    [LibraryImport("quickjs")][return: MarshalAs(UnmanagedType.I1)] public static partial bool JS_IsWeakMap(JSValue val);
    [LibraryImport("quickjs")][return: MarshalAs(UnmanagedType.I1)] public static partial bool JS_IsDataView(JSValue val);

    [LibraryImport("quickjs")] public static partial JSValue JS_NewArray(JSContext* ctx);
    [LibraryImport("quickjs")] public static partial JSValue JS_NewArrayFrom(JSContext* ctx, int count, JSValue* values);
    [LibraryImport("quickjs")][return: MarshalAs(UnmanagedType.I1)] public static partial bool JS_IsArray(JSValue val);

    [LibraryImport("quickjs")][return: MarshalAs(UnmanagedType.I1)] public static partial bool JS_IsProxy(JSValue val);
    [LibraryImport("quickjs")] public static partial JSValue JS_GetProxyTarget(JSContext* ctx, JSValue proxy);
    [LibraryImport("quickjs")] public static partial JSValue JS_GetProxyHandler(JSContext* ctx, JSValue proxy);
    [LibraryImport("quickjs")] public static partial JSValue JS_NewProxy(JSContext* ctx, JSValue target, JSValue handler);

    [LibraryImport("quickjs")] public static partial JSValue JS_NewDate(JSContext* ctx, double epoch_ms);
    [LibraryImport("quickjs")][return: MarshalAs(UnmanagedType.I1)] public static partial bool JS_IsDate(JSValue v);

    [LibraryImport("quickjs")] public static partial JSValue JS_GetProperty(JSContext* ctx, JSValue this_obj, JSAtom prop);
    [LibraryImport("quickjs")] public static partial JSValue JS_GetPropertyUint32(JSContext* ctx, JSValue this_obj, uint idx);
    [LibraryImport("quickjs")] public static partial JSValue JS_GetPropertyInt64(JSContext* ctx, JSValue this_obj, long idx);
    [LibraryImport("quickjs")] public static partial JSValue JS_GetPropertyStr(JSContext* ctx, JSValue this_obj, byte* prop);

    [LibraryImport("quickjs")] public static partial int JS_SetProperty(JSContext* ctx, JSValue this_obj, JSAtom prop, JSValue val);
    [LibraryImport("quickjs")] public static partial int JS_SetPropertyUint32(JSContext* ctx, JSValue this_obj, uint idx, JSValue val);
    [LibraryImport("quickjs")] public static partial int JS_SetPropertyInt64(JSContext* ctx, JSValue this_obj, long idx, JSValue val);
    [LibraryImport("quickjs")] public static partial int JS_SetPropertyStr(JSContext* ctx, JSValue this_obj, byte* prop, JSValue val);
    [LibraryImport("quickjs")] public static partial int JS_HasProperty(JSContext* ctx, JSValue this_obj, JSAtom prop);
    [LibraryImport("quickjs")] public static partial int JS_IsExtensible(JSContext* ctx, JSValue obj);
    [LibraryImport("quickjs")] public static partial int JS_PreventExtensions(JSContext* ctx, JSValue obj);
    [LibraryImport("quickjs")] public static partial int JS_DeleteProperty(JSContext* ctx, JSValue obj, JSAtom prop, int flags);
    [LibraryImport("quickjs")] public static partial int JS_SetPrototype(JSContext* ctx, JSValue obj, JSValue proto_val);
    [LibraryImport("quickjs")] public static partial JSValue JS_GetPrototype(JSContext* ctx, JSValue val);
    [LibraryImport("quickjs")] public static partial int JS_GetLength(JSContext* ctx, JSValue obj, long* pres);
    [LibraryImport("quickjs")] public static partial int JS_SetLength(JSContext* ctx, JSValue obj, long len);
    [LibraryImport("quickjs")] public static partial int JS_SealObject(JSContext* ctx, JSValue obj);
    [LibraryImport("quickjs")] public static partial int JS_FreezeObject(JSContext* ctx, JSValue obj);
    ...
    [LibraryImport("quickjs")] public static partial int JS_GetOwnPropertyNames(JSContext* ctx, JSPropertyEnum** ptab, uint* plen, JSValue obj, int flags);
    [LibraryImport("quickjs")] public static partial int JS_GetOwnProperty(JSContext* ctx, JSPropertyDescriptor* desc, JSValue obj, JSAtom prop);
    [LibraryImport("quickjs")] public static partial void JS_FreePropertyEnum(JSContext* ctx, JSPropertyEnum* tab, uint len);

    [LibraryImport("quickjs")] public static partial JSValue JS_Call(JSContext* ctx, JSValue func_obj, JSValue this_obj, int argc, JSValue* argv);
    [LibraryImport("quickjs")] public static partial JSValue JS_Invoke(JSContext* ctx, JSValue this_val, JSAtom atom, int argc, JSValue* argv);
    [LibraryImport("quickjs")] public static partial JSValue JS_CallConstructor(JSContext* ctx, JSValue func_obj, int argc, JSValue* argv);
    [LibraryImport("quickjs")] public static partial JSValue JS_CallConstructor2(JSContext* ctx, JSValue func_obj, JSValue new_target, int argc, JSValue* argv);
    [LibraryImport("quickjs")][return: MarshalAs(UnmanagedType.I1)] public static partial bool JS_DetectModule(byte* input, nuint input_len);
    [LibraryImport("quickjs")] public static partial JSValue JS_Eval(JSContext* ctx, byte* input, nuint input_len, byte* filename, int eval_flags);
    [LibraryImport("quickjs")] public static partial JSValue JS_Eval2(JSContext* ctx, byte* input, nuint input_len, JSEvalOptions* options);
    [LibraryImport("quickjs")] public static partial JSValue JS_EvalThis(JSContext* ctx, JSValue this_obj, byte* input, nuint input_len, byte* filename, int eval_flags);
    [LibraryImport("quickjs")] public static partial JSValue JS_EvalThis2(JSContext* ctx, JSValue this_obj, byte* input, nuint input_len, JSEvalOptions* options);
    [LibraryImport("quickjs")] public static partial JSValue JS_GetGlobalObject(JSContext* ctx);
    [LibraryImport("quickjs")] public static partial int JS_IsInstanceOf(JSContext* ctx, JSValue val, JSValue obj);
    [LibraryImport("quickjs")] public static partial int JS_DefineProperty(JSContext* ctx, JSValue this_obj, JSAtom prop, JSValue val, JSValue getter, JSValue setter, int flags);
    [LibraryImport("quickjs")] public static partial int JS_DefinePropertyValue(JSContext* ctx, JSValue this_obj, JSAtom prop, JSValue val, int flags);
    [LibraryImport("quickjs")] public static partial int JS_DefinePropertyValueUint32(JSContext* ctx, JSValue this_obj, uint idx, JSValue val, int flags);
    [LibraryImport("quickjs")] public static partial int JS_DefinePropertyValueStr(JSContext* ctx, JSValue this_obj, byte* prop, JSValue val, int flags);
    [LibraryImport("quickjs")] public static partial int JS_DefinePropertyGetSet(JSContext* ctx, JSValue this_obj, JSAtom prop, JSValue getter, JSValue setter, int flags);
    [LibraryImport("quickjs")] public static partial int JS_SetOpaque(JSValue obj, void* opaque);
    [LibraryImport("quickjs")] public static partial void* JS_GetOpaque(JSValue obj, JSClassID class_id);
    [LibraryImport("quickjs")] public static partial void* JS_GetOpaque2(JSContext* ctx, JSValue obj, JSClassID class_id);
    [LibraryImport("quickjs")] public static partial void* JS_GetAnyOpaque(JSValue obj, JSClassID* class_id);

    [LibraryImport("quickjs")] public static partial JSValue JS_ParseJSON(JSContext* ctx, byte* buf, nuint buf_len, byte* filename);
    [LibraryImport("quickjs")] public static partial JSValue JS_JSONStringify(JSContext* ctx, JSValue obj, JSValue replacer, JSValue space0);

    [LibraryImport("quickjs")] public static partial JSValue JS_NewArrayBuffer(JSContext* ctx, byte* buf, nuint len, delegate* unmanaged[Cdecl]<JSRuntime*, void*, void*, void> free_func, void* opaque, [MarshalAs(UnmanagedType.I1)] bool is_shared);
    [LibraryImport("quickjs")] public static partial JSValue JS_NewArrayBufferCopy(JSContext* ctx, byte* buf, nuint len);
    [LibraryImport("quickjs")] public static partial void JS_DetachArrayBuffer(JSContext* ctx, JSValue obj);
    [LibraryImport("quickjs")] public static partial byte* JS_GetArrayBuffer(JSContext* ctx, nuint* psize, JSValue obj);
    [LibraryImport("quickjs")][return: MarshalAs(UnmanagedType.I1)] public static partial bool JS_IsArrayBuffer(JSValue obj);
    [LibraryImport("quickjs")] public static partial int JS_IsImmutableArrayBuffer(JSValue obj);
    [LibraryImport("quickjs")] public static partial int JS_SetImmutableArrayBuffer(JSValue obj, [MarshalAs(UnmanagedType.I1)] bool immutable);
    [LibraryImport("quickjs")] public static partial byte* JS_GetUint8Array(JSContext* ctx, nuint* psize, JSValue obj);
    ...
    [LibraryImport("quickjs")] public static partial JSValue JS_NewTypedArray(JSContext* ctx, int argc, JSValue* argv, JSTypedArrayEnum array_type);
    [LibraryImport("quickjs")] public static partial JSValue JS_GetTypedArrayBuffer(JSContext* ctx, JSValue obj, nuint* pbyte_offset, nuint* pbyte_length, nuint* pbytes_per_element);
    [LibraryImport("quickjs")] public static partial JSValue JS_NewUint8Array(JSContext* ctx, byte* buf, nuint len, delegate* unmanaged[Cdecl]<JSRuntime*, void*, void*, void> free_func, void* opaque, [MarshalAs(UnmanagedType.I1)] bool is_shared);
    [LibraryImport("quickjs")] public static partial int JS_GetTypedArrayType(JSValue obj);
    [LibraryImport("quickjs")] public static partial JSValue JS_NewUint8ArrayCopy(JSContext* ctx, byte* buf, nuint len);
    ...
    [LibraryImport("quickjs")] public static partial JSValue JS_NewPromiseCapability(JSContext* ctx, JSValue* resolving_funcs);
    [LibraryImport("quickjs")] public static partial JSPromiseStateEnum JS_PromiseState(JSContext* ctx, JSValue promise);
    [LibraryImport("quickjs")] public static partial JSValue JS_PromiseResult(JSContext* ctx, JSValue promise);
    [LibraryImport("quickjs")][return: MarshalAs(UnmanagedType.I1)] public static partial bool JS_IsPromise(JSValue val);
    [LibraryImport("quickjs")] public static partial JSValue JS_NewSettledPromise(JSContext* ctx, [MarshalAs(UnmanagedType.I1)] bool is_reject, JSValue value);
    [LibraryImport("quickjs")] public static partial JSValue JS_NewSymbol(JSContext* ctx, byte* description, [MarshalAs(UnmanagedType.I1)] bool is_global);
    ...
    [LibraryImport("quickjs")]
    public static partial void JS_SetPromiseHook(JSRuntime* rt, delegate* unmanaged[Cdecl]<JSContext*, JSPromiseHookType, JSValue, JSValue, void*, void> promise_hook, void* opaque);

    [LibraryImport("quickjs")]
    public static partial void JS_SetHostPromiseRejectionTracker(JSRuntime* rt, delegate* unmanaged[Cdecl]<JSContext*, JSValue, JSValue, byte, void*, void> cb, void* opaque);

    [LibraryImport("quickjs")]
    public static partial void JS_SetInterruptHandler(JSRuntime* rt, delegate* unmanaged[Cdecl]<JSRuntime*, void*, int> cb, void* opaque);

    [LibraryImport("quickjs")] public static partial void JS_SetCanBlock(JSRuntime* rt, [MarshalAs(UnmanagedType.I1)] bool can_block);
    [LibraryImport("quickjs")] public static partial void JS_SetIsHTMLDDA(JSContext* ctx, JSValue obj);

    public struct JSModuleDef { }

    [LibraryImport("quickjs")]
    public static partial void JS_SetModuleLoaderFunc(JSRuntime* rt, delegate* unmanaged[Cdecl]<JSContext*, byte*, byte*, void*, byte*> module_normalize, delegate* unmanaged[Cdecl]<JSContext*, byte*, void*, JSModuleDef*> module_loader, void* opaque);

    [LibraryImport("quickjs")]
    public static partial void JS_SetModuleLoaderFunc2(JSRuntime* rt, delegate* unmanaged[Cdecl]<JSContext*, byte*, byte*, JSValue, void*, byte*> module_normalize, delegate* unmanaged[Cdecl]<JSContext*, byte*, void*, JSValue, JSModuleDef*> module_loader, delegate* unmanaged[Cdecl]<JSContext*, void*, JSValue, int> module_check_attrs, void* opaque);

    [LibraryImport("quickjs")] public static partial void JS_SetModuleNormalizeFunc2(JSRuntime* rt, delegate* unmanaged[Cdecl]<JSContext*, byte*, byte*, JSValue, void*, byte*> module_normalize);
    [LibraryImport("quickjs")] public static partial JSValue JS_GetImportMeta(JSContext* ctx, JSModuleDef* m);
    [LibraryImport("quickjs")] public static partial JSAtom JS_GetModuleName(JSContext* ctx, JSModuleDef* m);
    [LibraryImport("quickjs")] public static partial JSValue JS_GetModuleNamespace(JSContext* ctx, JSModuleDef* m);
    [LibraryImport("quickjs")] public static partial int JS_SetModulePrivateValue(JSContext* ctx, JSModuleDef* m, JSValue val);
    [LibraryImport("quickjs")] public static partial JSValue JS_GetModulePrivateValue(JSContext* ctx, JSModuleDef* m);

    [LibraryImport("quickjs")] public static partial int JS_EnqueueJob(JSContext* ctx, delegate* unmanaged[Cdecl]<JSContext*, int, JSValue*, JSValue> job_func, int argc, JSValue* argv);
    [LibraryImport("quickjs")][return: MarshalAs(UnmanagedType.I1)] public static partial bool JS_IsJobPending(JSRuntime* rt);
    [LibraryImport("quickjs")] public static partial int JS_ExecutePendingJob(JSRuntime* rt, JSContext** pctx);
    ...
    [LibraryImport("quickjs")] public static partial byte* JS_WriteObject(JSContext* ctx, nuint* psize, JSValue obj, int flags);
    [LibraryImport("quickjs")] public static partial byte* JS_WriteObject2(JSContext* ctx, nuint* psize, JSValue obj, int flags, JSSABTab* psab_tab);
    ...
    [LibraryImport("quickjs")] public static partial JSValue JS_ReadObject(JSContext* ctx, byte* buf, nuint buf_len, int flags);
    [LibraryImport("quickjs")] public static partial JSValue JS_ReadObject2(JSContext* ctx, byte* buf, nuint buf_len, int flags, JSSABTab* psab_tab);
    [LibraryImport("quickjs")] public static partial JSValue JS_EvalFunction(JSContext* ctx, JSValue fun_obj);
    [LibraryImport("quickjs")] public static partial int JS_ResolveModule(JSContext* ctx, JSValue obj);
    [LibraryImport("quickjs")] public static partial JSAtom JS_GetScriptOrModuleName(JSContext* ctx, int n_stack_levels);
    [LibraryImport("quickjs")] public static partial JSValue JS_LoadModule(JSContext* ctx, byte* basename, byte* filename);
    ...
    {
        [FieldOffset(0)] public delegate* unmanaged[Cdecl]<JSContext*, JSValue, int, JSValue*, JSValue> generic;
        [FieldOffset(0)] public delegate* unmanaged[Cdecl]<JSContext*, JSValue, int, JSValue*, int, JSValue> generic_magic;
        [FieldOffset(0)] public delegate* unmanaged[Cdecl]<JSContext*, JSValue, int, JSValue*, JSValue> constructor;
        [FieldOffset(0)] public delegate* unmanaged[Cdecl]<JSContext*, JSValue, int, JSValue*, int, JSValue> constructor_magic;
        [FieldOffset(0)] public delegate* unmanaged[Cdecl]<JSContext*, JSValue, int, JSValue*, JSValue> constructor_or_func;
        [FieldOffset(0)] public delegate* unmanaged[Cdecl]<double, double> f_f;
        [FieldOffset(0)] public delegate* unmanaged[Cdecl]<double, double, double> f_f_f;
        [FieldOffset(0)] public delegate* unmanaged[Cdecl]<JSContext*, JSValue, JSValue> getter;
        [FieldOffset(0)] public delegate* unmanaged[Cdecl]<JSContext*, JSValue, JSValue, JSValue> setter;
        [FieldOffset(0)] public delegate* unmanaged[Cdecl]<JSContext*, JSValue, int, JSValue> getter_magic;
        [FieldOffset(0)] public delegate* unmanaged[Cdecl]<JSContext*, JSValue, JSValue, int, JSValue> setter_magic;
        [FieldOffset(0)] public delegate* unmanaged[Cdecl]<JSContext*, JSValue, int, JSValue*, int*, int, JSValue> iterator_next;
    }

    [LibraryImport("quickjs")] public static partial JSValue JS_NewCFunction2(JSContext* ctx, delegate* unmanaged[Cdecl]<JSContext*, JSValue, int, JSValue*, JSValue> func, byte* name, int length, JSCFunctionEnum cproto, int magic);
    [LibraryImport("quickjs")] public static partial JSValue JS_NewCFunction3(JSContext* ctx, delegate* unmanaged[Cdecl]<JSContext*, JSValue, int, JSValue*, JSValue> func, byte* name, int length, JSCFunctionEnum cproto, int magic, JSValue proto_val);
    [LibraryImport("quickjs")] public static partial JSValue JS_NewCFunctionData(JSContext* ctx, delegate* unmanaged[Cdecl]<JSContext*, JSValue, int, JSValue*, int, JSValue*, JSValue> func, int length, int magic, int data_len, JSValue* data);
    [LibraryImport("quickjs")] public static partial JSValue JS_NewCFunctionData2(JSContext* ctx, delegate* unmanaged[Cdecl]<JSContext*, JSValue, int, JSValue*, int, JSValue*, JSValue> func, byte* name, int length, int magic, int data_len, JSValue* data);
    [LibraryImport("quickjs")] public static partial JSValue JS_NewCClosure(JSContext* ctx, delegate* unmanaged[Cdecl]<JSContext*, JSValue, int, JSValue*, int, void*, JSValue> func, byte* name, delegate* unmanaged[Cdecl]<void*, void> opaque_finalize, int length, int magic, void* opaque);

    public static JSValue JS_NewCFunction(JSContext* ctx, delegate* unmanaged[Cdecl]<JSContext*, JSValue, int, JSValue*, JSValue> func, byte* name, int length)
    {
        return JS_NewCFunction2(ctx, func, name, length, JSCFunctionEnum.JS_CFUNC_generic, 0);
    }

    public static JSValue JS_NewCFunctionMagic(JSContext* ctx, delegate* unmanaged[Cdecl]<JSContext*, JSValue, int, JSValue*, int, JSValue> func, byte* name, int length, JSCFunctionEnum cproto, int magic)
    {
    ...
    [LibraryImport("quickjs")] public static partial void JS_SetConstructor(JSContext* ctx, JSValue func_obj, JSValue proto);
    ...
    {
        [FieldOffset(0)] public JSCFunctionListEntryFunc func;
        [FieldOffset(0)] public JSCFunctionListEntryGetSet getset;
        [FieldOffset(0)] public JSCFunctionListEntryAlias alias;
        [FieldOffset(0)] public JSCFunctionListEntryPropList prop_list;
        [FieldOffset(0)] public byte* str;
    ...
    [LibraryImport("quickjs")] public static partial int JS_SetPropertyFunctionList(JSContext* ctx, JSValue obj, JSCFunctionListEntry* tab, int len);

    [LibraryImport("quickjs")] public static partial JSModuleDef* JS_NewCModule(JSContext* ctx, byte* name_str, delegate* unmanaged[Cdecl]<JSContext*, JSModuleDef*, int> func);
    [LibraryImport("quickjs")] public static partial int JS_AddModuleExport(JSContext* ctx, JSModuleDef* m, byte* name_str);
    [LibraryImport("quickjs")] public static partial int JS_AddModuleExportList(JSContext* ctx, JSModuleDef* m, JSCFunctionListEntry* tab, int len);
    [LibraryImport("quickjs")] public static partial int JS_SetModuleExport(JSContext* ctx, JSModuleDef* m, byte* export_name, JSValue val);
    [LibraryImport("quickjs")] public static partial int JS_SetModuleExportList(JSContext* ctx, JSModuleDef* m, JSCFunctionListEntry* tab, int len);
    ...
    [LibraryImport("quickjs")] public static partial byte* JS_GetVersion();
}
